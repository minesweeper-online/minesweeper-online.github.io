(function(sttc) {
    ...
    */
    ...
    function Ub(a) {
        ...
        Rb(a) || (a.length < 16 ? hb(Number(a)) : (a = BigInt(a), db = Number(a & BigInt(4294967295)) >>> 0, eb = Number(a >> BigInt(32) & BigInt(4294967295))), a = jb());
        return a
    }
    ...
    function fc(a, b, c, d, e) {
        if (a != null) {
            if (Array.isArray(a)) a = wb(a, void 0, 0) ? void 0 : e && (a[t] | 0) & 2 ? a : gc(a, b, c, d !== void 0, e);
            else if (vb(a)) {
                const f = {};
                for (let g in a) Object.prototype.hasOwnProperty.call(a, g) && (f[g] = fc(a[g], b, c, d, e));
                a = f
            } else a = b(a, d);
            return a
        }
    ...
    function gc(a, b, c, d, e) {
        ...
        d = d ? !!(f & 32) : void 0;
        a = kb(a);
        for (let g = 0; g < a.length; g++) a[g] = fc(a[g], b, c, d, e);
        c && c(f, a);
        return a
    }
    ...
    function kc(a, b, c = rb) {
        if (a != null) {
            ...
            if (Array.isArray(a)) {
                ...
                return b ? (a[t] = (d | 34) & -12293, a) : gc(a, kc, d & 4 ? rb : c, !0, !0)
            }
            a.qa === sb && (c = a.D, d = c[t], a = d & 2 ? a : bc(a.constructor, lc(c, d, !0)));
            return a
        }
    }
    ...
    function uc(a, b, c, d) {
        ...
        if (c >= e) {
            ...
            var f = a.length;
            return d && b & 256 && (d = a[f - 1][c], d != null) ? (vc(a, b, e, c) && mb != null && (a = Db ? ? (Db = {}), b = a[mb] || 0, b >= 4 || (a[mb] = b + 1, Hb())), d) : vc(a, b, e, c)
        }
    }
    ...
    function yc(a, b, c, d) {
        ...
        var h = d[t] | 0;
        if (sc(a, h, void 0, !1)) {
            if (4 & h || Object.isFrozen(d)) d = kb(d), h = Ac(h, f), f = z(e, f, b, d);
            let l = a = 0;
            for (; a < d.length; a++) {
                const m = c(d[a]);
                m != null && (d[l++] = m)
        ...
        let k;
        g === 1 || g === 4 && 32 & h ? Cc(h) || (f = h, h |= 2, h !== f && (d[t] = h), Object.freeze(d)) : (c = g !== 5 ? !1 : !!(32 & h) || Cc(h) || !!oc ? .get(d), (g === 2 || c) && Cc(h) && (d = kb(d), h = Ac(h, f), h = Dc(h, f, !1), d[t] = h, f = z(e, f, b, d)),
            Cc(h) || (b = h, h = Dc(h, f, !1), h !== b && (d[t] = h)), c && (k = nc(d)));
        return k || d
    }
    ...
    function Ec(a, b, c, d) {
        ...
        if (sc(a, g))
            for (g = 21, k && (c = kb(c), h = 0, g = Ac(g, f), g = Dc(g, f, !0)), k = 0; k < c.length; k++) c[k] = d(c[k]);
        l && (c = kb(c), h = 0, g = Ac(g, f), g = Dc(g, f, !0));
        g !== h && (c[t] = g);
        z(e, f, b, c);
        return a
    }
    ...
    function Fc(a, b) {
        ...
        else if (2 & g || 2048 & g) a = kb(a), e = 1, f && (e |= 32), a[t] = e, z(c, d, 4, a, !1);
        c = a;
        d = c[t] | 0;
        d = !!(4 & d) && !!(4096 & d);
        if (Array.isArray(b))
            for (var h = 0; h < b.length; h++) c.push(Vb(b[h], d));
        else
            for (h of b) c.push(Vb(h, d))
    }
    ...
    function Ic(a, b, c, d) {
        ...
        for (let f = 0; f < d.length; f++) {
            const g = d[f];
            uc(b, c, g) != null && (e !== 0 && (c = z(b, c, e)), e = g)
        }
        a.set(d, e);
        return e
    }
    ...
    function E(a, b, c, d) {
        ...
        if (g && !(8 & k || !d.length && (f === 1 || f === 4 && 32 & k))) {
            Cc(k) && (d = kb(d), k = Ac(k, a), a = z(e, a, c, d));
            b = d;
            g = k;
            for (l = 0; l < b.length; l++) k = b[l], m = mc(k), k !== m && (b[l] = m);
            g |= 8;
            g = b.length ? g & -17 : g | 16;
            k = b[t] = g
        }
        let n;
        f === 1 || f === 4 && 32 & k ? Cc(k) || (c = k, k |= !d.length || 16 & k && (!h || 32 & k) ? 2 : 2048, k !== c && (d[t] = k), Object.freeze(d)) : (h = f !== 5 ? !1 : !!(32 & k) || Cc(k) || !!oc ? .get(d), (f === 2 || h) && Cc(k) && (d = kb(d), k = Ac(k, a), k = Dc(k, a, !1), d[t] = k, a = z(e, a, c, d)), Cc(k) || (c = k, k = Dc(k, a, !1), k !== c && (d[t] = k)), h && (n = nc(d)));
        return n || d
    }
    ...
    function Qc(a, b, c) {
        ...
        if (l || k && f !== g) c = kb(c), g = 0, f = Ac(f, e), f = Dc(f, e, !0);
        f !== g && (c[t] = f);
        z(d, e, b, c);
        return a
    }
    ...
    */
    ...
    function sg(a, b, c, d, e) {
        if (a.j) {
            ...
            c = y(b, 2, w(c));
            d = y(c, 3, Ob(d));
            if (e.ga === void 0) Gc(d, 4, hf, w(e.O));
            else switch (e.ga) {
                case 3:
                    c = new bf;
                ...
                case 4:
                    ...
                    break;
                case 5:
                    c = new bf, c = Gc(c, 4, cf, w(e.property)), e = y(c, 1, w(e.O)), Pc(d, 5, hf, e)
            }
            e = new Yf;
            e = Pc(e, 9, Zf, d);
            hg(a.i, pg(a, e))
    ...
    function Lg(a, b, c, d, e = !1) {
        ...
        for (const n of b) {
            ...
            for (const q of a) {
                ...
                if (v) {
                    ...
                    k && N(Ag).j[n] ? .has(v) && f.push(k);h === 8 && b[v] ? (k = of (JSON.stringify(b[v])), h = Lc(q, Nc, 4), k = Zc(Mc(k), 4, A()), Fc(h, k)) :
        ...
        if (f.length || g.length) a = d ? ? void 0, c.j && c.u && (d = new Wf, f = Qc(d, 2, f), g = Qc(f, 3, g), a && B(g, 1, Ob(a), 0), f = new Yf, g = Pc(f, 7, Zf, g), hg(c.i, pg(c, g)))
    }
    ...
    function Kj(a) {
        ...
        } else b = b ? new Ej(b, Vc(a, 2), Vc(a, 5), Lj(G(a, 6))) : null;
        return b
    }
    var Mj = {
        1: 1,
    ...
    function Sj(a, b) {
        ...
        b.forEach(e => {
            ...
            } else ad(e, pj, 2, rj) ? Uj(a, ad(e, pj, 2, rj), c) : ad(e, nj, 3, rj) && Vj(a, ad(e, nj, 3, rj), d)
        });
        return new Wj(c,
            d)
    }
    ...
    var bk = (a, b, c) => W.ha(a, b, c),
        ...
        ek = (a, b, c, d) => {
            ...
            return e.indexOf("TagError") == 0 ? ((b instanceof Be ? b.error : b).pbr = !0, !1) : W.T(a, b, c, d)
        };
    var fk = class {
        constructor() {
            this.g = he();
    ...
    function sk(a, b) {
        ...
        b: {
            ...
            var l = (qk(e) ||
                Wa(e.document.querySelectorAll("div[id^=div-gpt-ad]"))).concat(Wa(e.document.querySelectorAll("iframe[id^=google_ads_iframe]")));
            ...
            let C = [].concat(Wa(e.document.querySelectorAll("iframe[id^=aswift_],iframe[id^=google_ads_frame]")), Wa(e.document.querySelectorAll("body ins.adsbygoogle")));f = [];
            for (const [gb, Zb] of [
                    [h.hc, k],
                    [h.yb, n],
                    [h.kc, q],
        ...
        for (g = 0; g < c.length; g++) {
            ...
            if (D(h, wh, 4) && e.contains(G(D(h, wh, 4), 1)) && G(h, 8) === 1 && uk(h, d)) {
                m.i++;
                if (l = vk(m, h, l, d)) k = Oj(m.g), k.numAutoAdsPlaced || (k.numAutoAdsPlaced = 0), D(h, Q, 1) && Vc(D(h, Q, 1), 5) != null && (k.numPostPlacementsPlaced ? k.numPostPlacementsPlaced++ :
    ...
    const xk = class {
        constructor(a, b, c, d, e) {
            ...
            this.j = c;
            this.A = e || null;
            (this.I = d) ? (a = a.document, d = E(d, qj, 5, A(Ab)), d = Sj(a, d)) : d = Sj(a.document, []);
            this.C = d;
            this.F = new lk;
            this.i = 0;
            this.u = !1
    ...
    function Wl(a) {
        !a.i || a.l.__uspapi || a.l.frames.__uspapiLocator || (a.l.__uspapiManager = "fc", Tl(a.l, "__uspapiLocator"), ta("__uspapi", (b, c, d) => {
    ...
    function Xl(a) {
        !a.tcString || a.l.__tcfapi || a.l.frames.__tcfapiLocator || (a.l.__tcfapiManager = "fc", Tl(a.l, "__tcfapiLocator"), a.l.__tcfapiEventListeners = a.l.__tcfapiEventListeners || [], ta("__tcfapi", (b, c, d, e) => {
    ...
    function Vm(a) {
        ...
        b ? (c = new xj, a = E(b, Fh, 1, A()), c = Qc(c, 1, a), a = E(b, sj, 2, A()), c = Qc(c, 7, a), S(ei) && E(b, Gh, 3, A()).length > 0 && (a =
            new Hh, b = E(b, Gh, 3, A()), b = Qc(a, 1, b), Oc(c, 6, b)), b = jh(c)) : b = lh(Error("invtag"));
        return b
    }
    ...
    var on = a => {
        ...
        S(pi) || (c.aiict = !0, c.aicel = an(Gi(oi)));
        S(vi) && (c.aipaq = !0);
        S(yi) && (c.aigda = !0);
        T(li) && (c.aiapm = T(li));
        T(mi) && (c.aiapmi = T(mi));
    ...
    function sn(a, b, c, d) {
        ...
        wc(c, wj, 24) && (d = Pj(a), d.availableAbg = !0, d.ablationFromStorage = !!D(c, wj, 24) ? .g() ? .g());
            ...
            if ((b = X(a).head_tag_slot_vars ? .google_ad_client ? ? a.document.querySelector(".adsbygoogle[data-ad-client]") ? .getAttribute("data-ad-client")) == null)
                if (S(Ai)) b = "";
                    ...
                    b: {
                        ...
                        /i(phone|pad|pod)/i.test(a) && /applewebkit/i.test(a) && !/version|safari/i.test(a) && !ze() ? wn : xn;
    ...
    function to(a, b, c, d, e) {
        ...
        return new jo(11,
            f === "in-article" ? new so(a, b) : new Zi(a, b))
    };
    ...
    function xo(a, b, c, d, e) {
        e.google_full_width_responsive == "false" ? c = {
            G: a,
            H: 1
        } : b === "autorelaxed" && e.google_full_width_responsive || yo(b) || e.google_ad_resize ? (b = Ui(a, c, d, e), c = b !== !0 ? {
            G: a,
            H: b
        } : {
            G: U(c) || a,
    ...
    function Fo(a, b, c, d, e) {
        ...
        if (h !== !0 || a === g) return new jo(12, new Zi(a, d), null, null, !0, h, 100);
        const {
            ca: k,
            Z: l,
            ta: m
            ...
            switch (a) {
                case 5:
                    const {
                        G: g,
                        H: h
                    } = bk(247, () => xo(b, d.google_ad_format, e, c, d));
                    h === !0 && b != g && Yi(e, c);
    ...
    function Po(a, b, c, d) {
        ...
        if (S(Rh) ||
            ...
            if (d = bn(f.location, "google_responsive_slot_preview") || S(ii) || Dm(f, 1, e, d)) b: if (b.google_reactive_ad_format || b.google_ad_resize || Ho(c, b) || Qi(a, b)) d = !1;
                else {
    ...
    async function ep(a) {
        ...
        if (b.j && !b.g.le.includes(1)) {
            ...
            a = cd(a, 4, b.A);
            d = Qo(b.l);
            d !== 0 && (e = new vf, d = y(e, 1, w(d)), Oc(a, 3, d));
            d = b.i;
            c = Zo(b, c);
            c = Pc(c, 4, Hf, a);
            ig(d, c);
    ...
    function rp(a, b) {
        ...
        for (const f of b)
            for (const g of E(f, mm, 2, A()))
                if (lm(g).length !== 0) {
                    b = Sc(Qb(tc(g, 8)), 0);
                    J(g, 4) && !J(g, 13) && (b = c.get(J(g, 4)) ? ? 0, d = Sc(Qb(tc(g, 1)), 0) * lm(g).length, c.set(J(g, 4), b + d));
                    d = [];
    ...
    function xp(a, b, c, d) {
        ...
        for (const n of [0, 1, 2])
            for (const [q, v] of a.oa[n].entries()) {
                ...
                else if (!a.Ca && (n === 2 ? (m = d[1], Gc(u, 2, Nf, w(k))) : m = d[0], k = m ? .(String(k)) ? ? (n === 2 && J(l[0].ua, 11) === 1 ? void 0 : d[0](String(k))), k !== void 0)) {
                    for (const x of l) {
                        if (x.ka !== b) continue;
                        l =
                            k - x.lb;
                        ...
                        const L = x.ib,
                            C = x.Cb;
                        l < 0 || l >= m * L || l % L !== C || !vp(a, x) || (l = J(x.ua, 13), l !== 0 && l !== void 0 && (m = a.j[String(l)], m !== void 0 && m !== x.R.getId() ? rg(a.M, a.j[String(l)], x.R.getId(), l) : a.j[String(l)] = x.R.getId()), h.push(x.R))
                    }
                    Kc(u, Nf) !== 0 && (B(u, 3, Ob(k), 0), g.push(u))
                }
            }
        for (const n of h) d = n.getId(), e.push(d), wp(a, d, f ? 4 : c), Lg(E(n, nf, 2, A()), f ? Ng() : [c], a.M, d);
        qg(a.M, b, c, e, g, 1);
        return e
    }
    ...
    function Ep({
        ...
        d.hasOwnProperty("init-done") ? (Pg(12, d, () => {})(E(a, nm, 2, A()).map(h => ed(h))), Pg(13, d, () => {})(E(a, nf, 1, A()).map(h => ed(h)), e), b && Pg(14, d, () => {})(b), Fp(e, d)) : (zp(new Ap(g, e, f, c), d), Qg(d), Rg(d), Sg(d), Fp(e, d), Lg(E(a, nf, 1, A(Ab)), [e], f, void 0, !0), vg = vg || !(!c || !c.Ab), Dp(qp), b && Dp(b))
    }
    ...
    function Ip(a, b, c) {
        ...
        if (d.plle) Fp(1, lp(a));
            ...
            for (const f of yc(b, 19, Pb, A())) N(Ug).i(f);
            Hp(12, a);
            Hp(10, a);
            a = Qd(a) || a;
    ...
    function Aq(a, b, c, d) {
        ...
        ap(f => {
            Yc(zf(f), 3) || (f = zf(f), bd(f, 3))
        });
        d.j() && Gq(a, d.g().g(), I(d, 2));
        var e = Fq(a);
        if (e !== 0)
            if (d = xm(), d.first_slotcar_request_processing_time || (d.first_slotcar_request_processing_time = Date.now(), d.adsbygoogle_execution_start_time = va), lq == null) Hq(a), mq.push(a);
            else if (e === 3) {
            const f = lq;
            bk(787, () => {
                f.handleAdConfig(a)
            })
        } else dk(730, lq.handleAdBreak(a));
        else {
            va = (new Date).getTime();
            Sn(c, d, yq(a));
            Iq();
    ...
    function Gq(a, b, c) {
        Nq || (Nq = !0, a = yq(a) || zn(O), ck("predictive_abg", {
            a_c: a,
            p_c: b.join(),
            b_v: c
        }, .01))
    ...
    (function(a, b, c, d = () => {}) {
        ...
        bk(166, () => {
            ...
            ap(m => {
                var n = Wc(m, 1) + 1;
                B(m, 1, Ob(n), 0);
                O.top === O && (n = Wc(m, 2) + 1, B(m, 2, Ob(n), 0));
                Yc(zf(m), 1) || (m = zf(m), bd(m, 1))
            });
            dk(1086, ep(h === 0));
            if (!Ka() || ya(Pa(), 11) >= 0) {
                ak(S(Fi));
